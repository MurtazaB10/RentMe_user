        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <a href="#">
                <strong>
                  <span className="mdi mdi-home"> Home</span>
                </strong>
              </a>{" "}
          ...
          <div className="row">
                  ...
                  <div className="card">
                    ...
                    >
                      <div className="card-body card-shop-filters">
                        {/* {obj.isloaded
                            ? obj.list.map((row, index) => {
                                return ( */}
                        <div className="card-body">
                          <div
                            className="list-group bs-canvas-close"
                            aria-label="Close"
                            // onClick={this.handleFilterCategory.bind(this, row)}
                          >
            ...
            <div className="col-md-9">
              ...
              <div className="row no-gutters">
                {/* {obj.categorybyproduct ? (
                    obj.categorybyproduct.map((row) =>
                      row.products.slice(0, obj.limit).map((row, index) => ( */}
